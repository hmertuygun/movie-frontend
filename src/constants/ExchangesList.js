...
import Huobi from '../api/functions/huobipro'
import OKEx from '../api/functions/okex'
...
export const options = [
  ...
  },
  {
    ...
    ticketSocketSubscribe: ByBit.ticketSocketSubscribe,
  ...
  },
  {
    ...
    fields: { Key: 'apiKey', Secret: 'secret' },
    socketUrl: Huobi.getSocketEndpoint,
    symbol: 'HUOBIPRO',
    socketEndpoint: 'wss://api-aws.huobi.pro/ws',
    apiUrl: 'https://api.huobi.pro',
    socketClass: KlineSocket,
    needPingAlive: true,
    getKlines: Huobi.getKlines,
    editSymbol: Huobi.editSymbol,
    editKline: Huobi.editKline,
    onSocketMessage: Huobi.onSocketMessage,
    initSubscribe: Huobi.initSubscribe,
    fetchTickers: Huobi.fetchTickers,
    editMessage: Huobi.editMessage,
    editSocketData: Huobi.editSocketData,
    socketSubscribe: Huobi.socketSubscribe,
    klineSocketUnsubscribe: Huobi.klineSocketUnsubscribe,
    preparePing: Huobi.preparePing,
    getIncomingSocket: Huobi.getIncomingSocket,
    fetchTicker: Huobi.fetchTicker,
    resolveGzip: Huobi.resolveGzip,
    ticketSocketSubscribe: Huobi.ticketSocketSubscribe,
    getTickerData: Huobi.getTickerData,
    getLastAndPercent: Huobi.getLastAndPercent,
    resolutions: [
      '1',
      '3',
      '5',
  ...
  },
  {
    ...
    placeholder: 'OKEx',
    fields: { Key: 'apiKey', Secret: 'secret', Passphrase: 'password' },
    socketUrl: OKEx.getSocketEndpoint,
    ...
    needPingAlive: true,
    socketClass: KlineSocket,
    getKlines: OKEx.getKlines,
    editSymbol: OKEx.editSymbol,
    editKline: OKEx.editKline,
    onSocketMessage: OKEx.onSocketMessage,
    editMessage: OKEx.editMessage,
    editSocketData: OKEx.editSocketData,
    fetchTickers: OKEx.fetchTickers,
    socketSubscribe: OKEx.socketSubscribe,
    klineSocketUnsubscribe: OKEx.klineSocketUnsubscribe,
    preparePing: OKEx.preparePing,
    getIncomingSocket: OKEx.getIncomingSocket,
    fetchTicker: OKEx.fetchTicker,
    ticketSocketSubscribe: OKEx.ticketSocketSubscribe,
