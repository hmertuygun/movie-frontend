...
const Accordion = (props) => {
  ...
  return (
    <>
      <div className="card">
        <div className="card-header py-0 pl-0 pr-0 pr-md-6" id="heading" data-toggle="collapse" role="button" data-target="#collapse" aria-expanded="false" aria-controls="collapse" onClick={toggleRow}>
      ...
      <span className="text-success text-md font-weight-bold">{PNL}</span>
                ...
                <div className="col col-lg-12 position-static px-0 text-lg-center">
                    <div className="d-flex flex-wrap flex-lg-nowrap align-items-center ">
                        ...
                        <div className="col-12 col-lg-3 px-0 position-static text-muted text-sm">
                            ...
                            <span className="badge badge-xs text-xs badge-light mr-2" id="value"> { date }</span>
                        </div>
                    </div>
        ...
        <div id="collapse" className={`collapse ${isOpen ? 'show' : ''}`} aria-labelledby="heading" data-parent="#accordion">
