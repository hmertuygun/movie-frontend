    ...
    if (isFormValid) {
      ...
      try {
        ...
        if (data?.status === 'error') {
          ...
          analytics.logEvent('placed_sell_take_profit_market_order')
          Event(
            'user',
            'placed_sell_take_profit_market_order',
            'placed_sell_take_profit_market_order'
          )
        }
        setValues({
...
export default TakeProfitMarketForm
