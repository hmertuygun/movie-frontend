...
const defaultErrorConfig = {
  ...
  icon: <FontAwesomeIcon icon={['fas', 'exclamation-triangle']} color="#fff" />,
}
...
const defaultInfoConfig = {
  ...
  icon: <FontAwesomeIcon icon={['fas', 'info-circle']} color="#fff" />,
}
const defaultSuccessConfig = {
  message: 'Success',
  description: '',
  className: 'notification-success',
  icon: <FontAwesomeIcon icon={['fas', 'check']} color="#fff" />,
}
